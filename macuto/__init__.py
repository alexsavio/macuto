...
#import nifti,
#        timeseries, atlas, files)

#__all__ = ['storage']

#__all__ = ['classification', 'nifti', 'timeseries',
#           'atlas', 'files']

#__storage_all__ = ['save_variables_to_shelve',
...
#__render_all__ = ['show_many_slices',
#                  'create_imglist_html',
...
#__all__.extend(__storage_all__)
