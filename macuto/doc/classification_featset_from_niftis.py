...
def set_parser():
    ...
    parser.add_argument('-r', '--roisdir',   dest='roisdir',   default='',     required=False,  help='rois directory path')
    parser.add_argument('-m', '--mask',      dest='mask_file', default='',     required=False,  help='rois directory path')
    ...
    parser.add_argument('-f', '--feats',     dest='feats',     default='jacs', required=False, choices=feats, help='deformation measure type')
    parser.add_argument(      '--otype',     dest='otype',     default='.npy', required=False, choices=outs,  help='output file type.')
