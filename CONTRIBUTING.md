...
The preferred way to contribute to macuto is to fork the 
[main repository](http://github.com/alexsavio/macuto/) on
GitHub:

1. Fork the [project repository](http://github.com/alexsavio/macuto):
   click on the 'Fork' button near the top of the page. This creates
   a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

          $ git clone git@github.com:YourLogin/macuto.git
...
Finally, go to the web page of the your fork of the macuto repo,
...
-  When adding additional functionality, provide at least one
   ...
   to other methods available in macuto.
...
A great way to start contributing to macuto is to pick an item
